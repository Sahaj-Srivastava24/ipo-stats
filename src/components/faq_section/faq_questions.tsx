  ...
  return (
    <div>
      <Collapse.Group>
        ...
        <Collapse
          title={
            <Title text="Difference between Book Building Issue and Fixed Price Issue?" />
          }
        >
          <Text className="text-12 text-[#777E90] md:text-16">
        ...
        <Collapse
          title={
            <Title text="Difference between IPO Cut-Off Price and Floor Price?" />
          }
        >
          <Text size={16} className="text-12 text-[#777E90] md:text-16">
        ...
        <Collapse
          title={
            <Title text="What is minimum number of days for which bid should remain open in book building?" />
          }
        >
          <Text size={16} className="text-12 text-[#777E90] md:text-16">
        ...
        <Collapse
          title={
            <Title text="What is the main difference between offer of shares through book building and offer of shares through normal public issue?" />
          }
        >
          <Text size={16} className="text-12 text-[#777E90] md:text-16">
