import {Button, CSS, Input, Modal, Radio, Text} from "@nextui-org/react";
...
export default function Feedback() {
  ...
  const btnCss: CSS = {
    ...
    bgColor: '$primaryLight !important',
    zIndex: 3,
  }
